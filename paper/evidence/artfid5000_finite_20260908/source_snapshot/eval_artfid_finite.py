...
def main():
    ...
    historical = json.loads((results / "provenance.json").read_text(encoding="utf-8"))
    ...
    provenance = dict(
        ...
        historical_provenance_sha256=digest(results / "provenance.json"),
        historical_summary_sha256=digest(results / "summary.csv"),
